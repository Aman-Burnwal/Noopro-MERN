...
import { updateProfile } from "../../../../hook/profile"
  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-300 bg-richblack-600 p-8 px-12">
          ...
          <div className="flex flex-col gap-5 lg:flex-row ">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                className="relative rounded w-fit bg-richblue-25 pl-3 py-3
         ...
         placeholder:text-richblue-200 placeholder:text-sm "
                ...
                defaultValue={user?.additonDetail?.dateOfBirth}
              />
              {errors.dateOfBirth && (
                <span className="-mt-1 text-[12px] text-yellow-100">
         ...
         placeholder:text-richblue-200 placeholder:text-sm "
                ...
                defaultValue={user?.additonDetail?.contactNumber}
              />
         ...
         placeholder:text-richblue-200 placeholder:text-sm "
                ...
                defaultValue={user?.additonDetail?.about}
              />
              {errors.about && (
                <span className="-mt-1 text-[12px] text-yellow-100">
