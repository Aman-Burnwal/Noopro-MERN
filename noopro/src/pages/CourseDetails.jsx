...
import { Error, Footer, GetAvgRating, RatingStars } from "../utils"
...
import { fetchCourseDetails, buyCourse } from "../hook/Courses"
...
function CourseDetails() {
  ...
  // console.log("response: ", response?.ratingAndReviews)
  ...
  const {
    _id: course_id,
    courseName,
    coureDiscription: courseDescription,
    thumbnail: thumbnail,
    price,
  ...
  return (
    <div className="bg-richblack-800 ">
      ...
      <div className="mx-auto bg-richblack-800 box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
